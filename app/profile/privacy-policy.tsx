      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            At Plandid, we collect information you provide directly to us, such
            as when you create an account, fill out a form, or contact us. This
            may include your name, email address, phone number, wedding date,
            and location preferences.
          </ThemedText>
          <ThemedText type="body" style={styles.paragraph}>
            We also collect information automatically when you use our services,
            including device information, usage data, and location information
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            ...
            our services, including matching you with relevant vendors,
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            ...
            us at privacy@plandid.com or through the contact information
            provided in our app.
          </ThemedText>
        </View>
